...
module.exports = async (id, email, name) => {
    ...
    ON DUPLICATE KEY UPDATE
        ...
        alter_request_date = ?
     `, [id, confirmation_code, new Date(), new Date()])
