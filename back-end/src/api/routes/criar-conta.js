...
module.exports = async (req, res) => {
    ...
    bcrypt.hash(senha, 10, async (err, hash) => {
        ...
        try {
            ...
            const confirmation_code = Math.floor(Math.random() * 100000).toString()

            await db.execute('INSERT INTO user_email_confirmation (user, confirmation_code, alter_request_date) VALUES (?, ?, ?)', [
                user.insertId,
                confirmation_code,
                new Date()
            ])
